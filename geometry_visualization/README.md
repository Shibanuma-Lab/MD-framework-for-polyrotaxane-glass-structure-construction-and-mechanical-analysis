...
| No. | Script | Function |
|-----|---------|-----------|
| 1 | `1_separate_chain_and_ring.py` | Separates chain and ring atoms from the full LAMMPS data file |
| 2 | `2_extract_backbone.py` | Extracts the backbone atoms and writes simplified main-chain coordinates |
| 3 | `3_extract_coordinate.py` | Calculates the geometric centers of CD molecules (with PBC correction) |
| 4 | `4_extract_normal_vector.py` | Computes the orientation (normal vector) of each CD molecule |
| 5 | `5_plot.py` | Visualizes the PRg model using PyVista (chain, chain ends, CDs) |
